...
typedef native_sys_get_info_func = Int32 Function(
  Int32 infoID,
  Pointer<Utf8> outBuf,
...
typedef native_port_readlen_func = Int32 Function(
    Int32 portType, Pointer<Int32> outLen);
typedef native_port_read_func = Int32 Function(
    Int32 portType, Pointer<Uint8> buf, Pointer<Int32> bufLen, Int32 timeout);
typedef native_port_close_func = Int32 Function(Int32 portType);

// Dart
typedef SysGetInfo = int Function(
  int infoID,
  Pointer<Utf8> outBuf,
  Pointer<Int32> outBufLen,
);
